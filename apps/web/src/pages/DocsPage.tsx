export function DocsPage() {
  const steps = [
    ...
    { title: 'Settle', desc: 'Veyra submits the voucher to Soroban — Bob receives XLM.' },
  ];

  return (
    <div className="p-6 max-w-2xl animate-fade-in">
      <h1 className="text-2xl font-bold mb-2">How Veyra Works</h1>
      ...
      <div className="card mt-4 border-accent-yellow/20 bg-accent-yellow/5">
        ...
        <p className="text-xs text-text-muted">
          Veyra never claims an offline payment is settled on Stellar until it actually is.
